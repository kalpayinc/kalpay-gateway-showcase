! function(e) {
    ...
    var i = function(n) {
        t.script = $script.noConflict(), t.script("https://kalpay-gateway-resources.s3.us-east-2.amazonaws.com/v0/supersdk.templating.js", function() {
            ...
            }), o(), e.superSDK.easyXDM && (e.superSDK.app_rpc = new e.superSDK.easyXDM.Rpc({
                remote: "https://dev.gateway.kalpayinc.com/",
    ...
    t.prototype.init = function(t, n) {
        i(function() {
            ...
            e.superSDK.modal_rpc.payment_status(""), e.superSDK.modal_rpc.destroy(), o()
        }), this.listen("PAYMENT_SUCCEEDED", function() {
            var t = e.superSDK;
            setTimeout(() => {
                r(), t.settings.success_url && (e.location = t.settings.success_url)
            }, 1e3)
        }), this.listen("PAYMENT_FAILED", function() {
            var t = e.superSDK;
            setTimeout(() => {
                r(), t.settings.failed_url && (e.location = t.settings.failed_url)
            }, 1e3)
        })
    ...
    var a = t => {
            const o = localStorage.getItem("supersdk.invoice") ? JSON.parse(localStorage.getItem("supersdk.invoice"))._id : null;
            let s = {
                payment: {
                    ...t,
                    type: "Payment",
            ...
            e.superSDK.api("/transaction/init", "POST", s, function(t) {
                const {
                    data: s,
                    error: r
                } = t;
                if (s) e.superSDK.modal_rpc.initTransactionCllbk(!0, null), n && 1 === n.readyState ? n.send(JSON.stringify({
                    event: "invoice",
                    data: o
                })) : ((() => {
                    ...
                    (n = new WebSocket(`${t}dev.ws.invoice.kalpayinc.com`)).onmessage = (t => {
                        ...
                        if (n) {
                            ...
                            e.superSDK.modal_rpc.completeTransactionCllbk(o)
                        }
                    })
                })(), 1 === n.readyState && n.send(JSON.stringify({
                    event: "invoice",
                    data: o
